  ...
  return (
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .img-inner {
          ...
          background: #140820;
          /* size controlled by CSS var set inline */
        ...
        /* Desktop nav: auto-shrink font & gap */
        .nav-list {
        ...
        .hero-inner {
          ...
          max-width: 1280px; margin: 0 auto;
          padding: 80px 20px 60px;   /* top clears 60px nav */
          display: flex;
        ...
        @media (min-width: 860px) {
          .hero-text-col { align-items: flex-start; text-align: left; }
        }
        ...
        /* Eyebrow line — centered on mobile, left on desktop */
        .eyebrow {
      ...
      >
        <div className="nav-wrap">
          ...
          <motion.div whileHover={{ scale:1.05 }} style={{ position:"relative", flexShrink:0 }}>
            <h1 style={{ fontFamily:"'Playfair Display',serif", fontWeight:900,
              fontSize:"clamp(20px,3vw,26px)", margin:0,
          ...
          <button onClick={() => setMobileMenuOpen(v => !v)} className="md:hidden"
            style={{ background:"none", border:"none", cursor:"pointer",
              fontSize:22, color:PINK, padding:"4px 6px", lineHeight:1, flexShrink:0 }}>
            {mobileMenuOpen ? "✕" : "☰"}
          </button>
        </div>
        ...
        {mobileMenuOpen && (
          <motion.div initial={{ opacity:0, height:0 }} animate={{ opacity:1, height:"auto" }}
            ...
            <ul style={{ listStyle:"none", padding:"10px 20px 20px", margin:0,
              display:"flex", flexDirection:"column", gap:14 }}>
              {navItems.map(item => (
                <li key={item}>
                  <a href={`#${item}`} onClick={() => setMobileMenuOpen(false)}
                    style={{ fontFamily:"'DM Sans',sans-serif", fontSize:16,
                      fontWeight:500, color:"#d1d5db", textDecoration:"none" }}>
                    {item}
                  </a>
                </li>
              ))}
      ...
      <div id="Home" className="hero-section">
              ...
              <div style={{ position:"relative", display:"inline-block" }}>
                ...
                <motion.div animate={{ rotate:360 }} transition={{ duration:10, repeat:Infinity, ease:"linear" }}
                  style={{ position:"absolute", inset:-10, borderRadius:"50%",
                    border:`2px dashed ${PINK}55`, pointerEvents:"none" }}/>
                <motion.div animate={{ rotate:-360 }} transition={{ duration:16, repeat:Infinity, ease:"linear" }}
                  style={{ position:"absolute", inset:-22, borderRadius:"50%",
                    border:`2px dashed ${PURPLE}33`, pointerEvents:"none" }}/>
                {/* Glow */}
                ...
                {/* Photo — responsive via CSS var */}
                <div className="img-ring">
                  <div className="img-inner"
                    style={{ "--img-size": "clamp(160px, 36vw, 260px)" }}>
            ...
            <motion.div className="hero-text-col"
              ...
              <motion.div className="stats-row"
                ...
                {[{ value:"2+", label:"Internships" },{ value:"10+", label:"Projects" },{ value:"3.20", label:"CGPA" }].map((s,i)=>(
                  <div key={i} className="stat-box"
                    style={{ background:GRAD_T, border:`1px solid ${PINK}30`,
              ...
              <motion.div className="cta-row"
                ...
                <motion.a href="#Projects" className="cta-btn"
                  ...
                  whileTap={{ scale:0.95 }}
                  style={{ background:GRAD, color:"#fff", padding:"12px 22px",
                ...
                <motion.a href="#Contact" className="cta-btn"
                  ...
                  style={{ background:"transparent", border:`2px solid ${PINK}66`,
                    color:PINK, padding:"12px 22px", borderRadius:50,
                    fontFamily:"'DM Sans',sans-serif", fontWeight:600,
                    fontSize:"clamp(13px,1.4vw,15px)", textDecoration:"none",
        ...
        {/* Scroll indicator — chevron icon only, no text, hidden on mobile */}
        <motion.div className="hidden md:block"
          style={{ position:"absolute", bottom:24, left:"50%", transform:"translateX(-50%)", cursor:"pointer" }}
          animate={{ y:[0,8,0] }} transition={{ duration:1.6, repeat:Infinity, ease:"easeInOut" }}
          onClick={() => document.getElementById("About")?.scrollIntoView({ behavior:"smooth" })}>
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6 9l6 6 6-6" stroke="url(#chevGrad)" strokeWidth="2.2"
              strokeLinecap="round" strokeLinejoin="round"/>
            <defs>
              <linearGradient id="chevGrad" x1="6" y1="9" x2="18" y2="15" gradientUnits="userSpaceOnUse">
